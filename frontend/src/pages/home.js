    ...
    <>
      ...
      >
        <div className="container-fluid text-center row">
          <div className="banner-text col-9">
        ...
        <div className="container">
          <div className="trending-content">
            <div className="content-title d-flex justify-content-center">
              <h1><span className='content-title-span'>Trending</span> Items</h1>
            </div>
            <div className='product d-flex'>
                <div className='flex-column text-center align-center m-3'>
                  <img src={banner} className='product-image rounded mx-auto d-block'></img>
                  <a href="" className='product-link'>
                    Product Name<br></br>
                    Description
                  </a>
                  <div className='product-price my-2'>₱Price</div>
                </div>
                <div className='flex-column text-center align-center m-3'>
                  <img src={banner} className='product-image rounded mx-auto d-block'></img>
                  <a href="" className='product-link'>
      ...
      <section className='service container'>
        <div className='content-title d-flex justify-content-center mb-5'>
          ...
          <h1><span className='content-title-span'>Happyness and Satisfaction</span><br></br>
          under one roof for your little friends.</h1>
          </div>
        </div>
        <div className='d-flex flex-row text-center'>
          <div className='flex-column'>
            ...
            <div className='service-text'>Order by 1 pm local time on the same-day to get free delivery on orders ₱ 1,000+ today</div>
          </div>
          <div className='flex-column'>
            ...
            <div className='service-text'>35% off your first repeat delivery order</div>
          </div>
          <div className='flex-column'>
            <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor" class="bi bi-shield-check" viewBox="0 0 16 16">
            ...
            <div className='service-text'>20% off your online order of ₱ 2,000+</div>
          </div>
          <div className='flex-column'>
            <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor" class="bi bi-person-check" viewBox="0 0 16 16">
            <path d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Zm1.679-4.493-1.335 2.226a.75.75 0 0 1-1.174.144l-.774-.773a.5.5 0 0 1 .708-.708l.547.548 1.17-1.951a.5.5 0 1 1 .858.514ZM11 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0ZM8 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/>
            <path d="M8.256 14a4.474 4.474 0 0 1-.229-1.004H3c.001-.246.154-.986.832-1.664C4.484 10.68 5.711 10 8 10c.26 0 .507.009.74.025.226-.341.496-.65.804-.918C9.077 9.038 8.564 9 8 9c-5 0-6 3-6 4s1 1 1 1h5.256Z"/>
          </svg>
            <h4 className=''>24/7 Support</h4>
            <div className='service-text'>Our customer service agent will cater your need at any time of the day</div>
          </div>
        </div>
      </section>
      <section className='cat-banner mb-5' style={{backgroundImage: `url(${adsbg})`}}>
        <div className='container d-flex flex-row align-items-center'>
          <img src={adsbanner} className='cat-banner-image img-fluid'></img>
          <div className='flex-column'>
            <div className='cat-banner-text cat-banner-title my-1'>Healthy pets are what we pledge to bring you.</div>
            <div className='cat-banner-text my-1'>Why not give the best to the ones you love the most?</div>
      ...
      <section className='popular-brands mb-5'>
        <div className="content-title d-flex justify-content-center">
          <h1><span className='content-title-span'>Popular</span> Brands</h1>
        </div>
